...
namespace PARK.APP.FIRST.Areas.VulnManage.Controllers
{
    ...
    public class TvulnsController : Controller
    {
        ...
        #region+ Model Class (Index_02, Index_04)
        ...
        #region+ Model Class (Index_06)
        public class ViewModels06
        {
            public List<PageVuln06> PageVuln06s { get; set; }
            public PageDefault06 PageDefault06s { get; set; }
            public int PageListTotalCount { get; set; }
            public PageSearchModel PageSearchModels { get; set; }
        }

        public class PageVuln06
        {
            public Int64 VULN_SEQ { get; set; }
            public string VULN_NAME { get; set; }
            public Int64 GROUP_SEQ { get; set; }
        ...
        public class PageDefault06
        {
            public string Theme { get; set; }
            public string Setting { get; set; }

            public PageDefault06()
            {
                Theme = "metro";
                Setting = "Controller Setting";
            }
        ...
        public string Index_06(string jsonData)
        {
            ...
            List<PageVuln06> allVulns = _context.Tvuln.Select(r => new PageVuln06
            {
                GROUP_SEQ = r.GroupSeq,
                VULN_SEQ = r.VulnSeq,
                CREATE_USER_ID = r.CreateUserId,
            ...
            ViewModels06 viewModel06s = new ViewModels06
            {
                PageVuln06s = FilterItems(jsonData, allVulns, ref count),
                PageDefault06s = new PageDefault06(),
        ...
        #region+ Create, Detail, Edit, Delete...
